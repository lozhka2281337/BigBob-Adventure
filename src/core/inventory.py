...
class Inventory:
    def __init__(self):
        self._all_weapons = [
            ...
            Laser("Defrag", 5, 50, 1, 2500, duration=800, beam_width=14, color=(0, 255, 255), charge_time=400),
        ...
        self.weapons = [Gun("Scanner", 50, 20, 10, 1000, 800, (255, 255, 0))]
        self.current_idx = 0
    ...
    def get_all_weapons(self):
        self.weapons = self._all_weapons